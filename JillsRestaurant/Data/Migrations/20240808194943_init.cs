...
namespace JillsRestaurant.Data.Migrations
{
    /// <inheritdoc />
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, "muy delicioso taco", "Lentil Lover", 2.0m, 75 },
                    { 2, 2, "loaded black bean burrito bowl", "Black Bean Banger", 2.5m, 50 },
                    { 3, 1, "es imposible", "Impossible Nachos", 3.0m, 25 }
                });
